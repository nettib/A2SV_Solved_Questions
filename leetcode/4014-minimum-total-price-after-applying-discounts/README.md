...
**Problem:** [Minimum-Total-Price-After-Applying-Discounts](https://leetcode.com/problems/minimum-total-price-after-applying-discounts)
...
Example 1:**Input:** prices = [10,30,21], discounts = [50,60]
