...
**Problem:** [Earliest-Finish-Time-for-Land-and-Water-Rides-I](https://leetcode.com/problems/earliest-finish-time-for-land-and-water-rides-i)
...
- Water rides waterStartTime[j] &ndash; the earliest time the `jth` water ride can be boarded.
