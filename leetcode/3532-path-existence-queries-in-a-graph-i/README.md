...
**Problem:** [Path-Existence-Queries-in-a-Graph-I](https://leetcode.com/problems/path-existence-queries-in-a-graph-i)
...
Example 1:**Input:** n = 2, nums = [1,3], maxDiff = 1, queries = [[0,0],[0,1]]
